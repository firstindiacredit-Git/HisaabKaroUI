      ...
      <div className="hidden sm:block p-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-3 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-700 font-medium text-sm sm:text-base truncate">{bookName}</p>
            </div>
          </div>
          ...
          {/* Client Name Card */}
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-purple-600 rounded-xl blur opacity-25 group-hover:opacity-40 transition duration-200"></div>
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-3 sm:p-6 hover:shadow-lg transition-shadow duration-200">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-3 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-700 font-medium text-sm sm:text-base">{Math.abs(outstandingBalance).toLocaleString('en-IN')}</p>
            </div>
          </div>
        </div>
      </div>
