...
import { Image, Button, Dropdown, Space, Skeleton, Badge, message } from "antd";
...
const CollaborativeBookRecords = () => {
  ...
  // Add this function to handle message page changes
    ...
    <div className="min-h-screen dark:bg-gray-900 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="hidden sm:block dark:text-white  mt-4 text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-8 text-center sm:text-left">
          Transaction Details collaborative book
        </h1>
                              ...
                              <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                {userId === history?.initiaterId ? (
                                  <div className="flex space-x-3">
                                    <button
                                      onClick={() => handleMessageClick(history)}
                                      className="text-blue-600 hover:text-blue-900 transition-colors"
                                      title="Message"
                                    >
                                      <Badge count={history.unreadCount || 0} offset={[-5, 5]}>
                                  ...
                                  <div className="flex space-x-3">
                                    ...
                                    >
                                      <Badge count={history.unreadCount || 0} offset={[-5, 5]}>
                                        <AiOutlineMessage className="h-5 w-5 dark:text-gray-300" />
                                      </Badge>
                                    </button>
                                  </div>
                                )}
        ...
        {selectedTransaction && selectedTransaction.transactionId && selectedTransaction.entryId && (
          <MessageModal
            ...
            otherUser={transaction.clientUserId}
