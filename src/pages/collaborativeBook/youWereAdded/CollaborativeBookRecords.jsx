...
const CollaborativeBookRecords = () => {
  ...
  // Update the filter controls for mobile
  const renderFilterControlsMobile = () => (
    <div className="flex flex-wrap gap-2 mb-4">
      <button className="flex items-center px-4 py-2 bg-gray-100 rounded-lg text-gray-700 text-sm">
    ...
    <div className="min-h-screen dark:bg-gray-900 bg-gray-50">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="container mx-auto">
          ...
          {/* Transaction History */}
          <div className="shadow overflow-hidden border-b dark:border-gray-700 border-gray-200 sm:rounded-lg overflow-x-auto">
