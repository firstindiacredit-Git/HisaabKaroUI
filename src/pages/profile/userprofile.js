...
const GetUserProfile = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen dark:bg-gray-900 bg-white flex flex-col items-center py-12 px-4 relative"
    >
      ...
      >
        ...
        {userProfile ? (
          <motion.div
            className="bg-white/90 dark:bg-gray-800 backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 relative group"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
