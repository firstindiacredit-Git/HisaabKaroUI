...
const templates = [
  {
    ...
    description: "A professional and clean invoice layout",
    image: (
      <svg
  ...
  },
  {
    ...
    image: (
      ...
      >
        ...
        {/* Total */}
        <rect x="240" y="260" width="120" height="30" rx="15" fill="#3B82F6" />
  ...
  },
  {
    ...
    description: "Simple and straightforward layout",
    image: (
      <svg
        className="w-full h-full"
        viewBox="0 0 400 300"
  ...
  },
  {
    ...
    description: "Corporate style with detailed breakdown",
    image: (
      <svg
        className="w-full h-full"
        viewBox="0 0 400 300"
      ...
      >
        ...
        <text x="220" y="100" className="text-sm font-semibold" fill="#1E40AF">
          To
        </text>
  ...
  return (
    <div className="w-full dark:bg-gray-900 bg-white mx-auto p-6">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Choose Invoice Template</h1>
        <button
          onClick={() => navigate("/invoice/new")}
          className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-colors duration-300 flex items-center space-x-2"
        >
          <svg
            className="w-5 h-5"
            fill="none"
