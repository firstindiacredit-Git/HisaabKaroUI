...
const CredentialManager = () => {
  ...
  const handleInputpinChange = (value, index) => {
  ...
  const handleKeyDown = (e, index) => {
    if (e.key === "Backspace" && !pin[index] && index > 0) {
      document.getElementById(`pin-${index - 1}`).focus(); // Move to the previous input
    }
    ...
    if (enteredNewPin.length === 4) {
      try {
        const response = await api.patch(`/users/update-pin/${userId}`, {
          currentPin: correctPassword,
          newPin: enteredNewPin
        });
        if (response.status === 200) {
          setCorrectPassword(enteredNewPin);
          setNewPin(["", "", "", ""]);
                ...
                <div className="flex justify-center mt-4 space-x-2 mb-4">
                  {pin.map((value, index) => (
                    <input
                      ...
                      value={value}
                      onChange={(e) =>
                        handleInputpinChange(e.target.value, index)
                      }
            ...
            <div className="flex justify-between w-[68%] xl:w-[79.2%]  items-center">
              ...
              <div className="relative flex space-x-1 w-1/2  mb-4">
                <input
                  ...
                  className="w-full rounded-md px-4 py-2 bg-gray-200 dark:bg-gray-800 dark:text-white  rounded-xs focus:outline-none focus:ring-2 focus:ring-gray-800"
                />
            ...
            <div className="flex justify-between  space-x-4 w-full ">
              {isGridView ? (
                filteredCredentials.length > 0 ? (
                  ...
                  <div className="flex  flex-col w-[70%] xl:w-[80%] p-5 dark:bg-gray-800 bg-white rounded-md  border border-gray-800/10 min-h-72 justify-center items-center  text-gray-500">
                    <FiPlusCircle
                      size={80}
                      onClick={() => showModal()}
                ...
                <div className="overflow-x-auto w-[80%] min-h-72 dark:bg-gray-800 bg-white border  border-black/10 rounded-sm">
                  {filteredCredentials.length > 0 ? (
                    <>
                      <table className="min-w-full  rounded-sm  table-auto">
                        <thead className="dark:bg-gray-800 border-b border-gray-600 dark:text-gray-400 bg-gray-100 rounded-sm">
                          ...
                          {filteredCredentials.map((cred, index) => (
                            ...
                            >
                              ...
                              <td className="py-2 px-4 text-gray-700  max-w-12">
                                <div className="flex  px-1 min-w-fit  dark:bg-gray-800 dark:text-gray-400  bg-gray-50 border border-gray-200/20 rounded-xs justify-between items-center space-x-2 whitespace-nowrap">
                                  <span
                              ...
                              <td className="py-2 text-gray-500 px-4  max-w-12">
                                <div className="flex dark:bg-gray-800 min-w-fit dark:text-gray-400 bg-gray-50 border border-gray-200/20 px-1 rounded-xs justify-between items-center space-x-2 whitespace-nowrap">
                                  <span
                                    className="overflow-hidden   lg:max-w-24 max-w-[14ch]"
                                    title={cred.password}
                                  >
              ...
              <div className="w-[30%]   xl:w-[20%] ">
                <div>
                  <h2
                    className={`font-semibold dark:bg-gray-800 rounded-md py-2 bg-gray-200 ${
