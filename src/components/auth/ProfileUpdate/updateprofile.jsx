...
const ProfileUpdate = ({ onClose, onUpdate }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <div className="space-y-3 dark:bg-gray-900 bg-white/20 p-4 rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-3" encType="multipart/form-data">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-sm dark:bg-gray-800 dark:text-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
          ...
          <div>
            ...
            <input
              ...
              disabled
              className="w-full px-3 py-1.5 text-sm dark:bg-gray-800 dark:text-white border border-gray-200 rounded-lg bg-gray-50 text-gray-500 cursor-not-allowed"
          ...
          <div className="flex justify-end space-x-2 pt-3">
            <button
              type="button"
              onClick={onClose}
              className="px-3 py-1.5 text-sm font-medium text-gray-700 dark:bg-gray-800 dark:text-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            ...
            <button
              type="submit"
              className="px-3 py-1.5 text-sm font-medium text-white bg-blue-600 dark:bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
