...
const GSTCalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 p-6 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-[30px] shadow-md border-2 border-gray-100 dark:border-gray-700  ">
          ...
          <h1 className="text-3xl dark:text-gray-100   font-bold text-gray-900 text-center mb-8">
            GST Calculator
          </h1>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-800   rounded-2xl p-12">
                <form onSubmit={calculateGST} className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-600 dark:text-gray-100  mb-2">
                      Calculation Type
                    </label>
                    <div className="grid grid-cols-2 gap-2">
                      <div className="relative">
                        <button
                          ...
                          onMouseEnter={() =>
                            setShowTooltip({ ...showTooltip, exclusive: true })
                          }
                          onMouseLeave={() =>
                            setShowTooltip({ ...showTooltip, exclusive: false })
                          }
                        ...
                        {showTooltip.exclusive && (
                          <div className="absolute z-10 w-64 p-2 mt-2 text-sm text-white bg-gray-900 dark:bg-gray-800 rounded-lg shadow-lg">
                            When GST is exclusive, the tax is added to the base
                            amount. Example: Base 100 + 18% GST = Total 118
                          </div>
                        )}
                      </div>
                      <div className="relative">
                        <button
                          ...
                          onMouseEnter={() =>
                            setShowTooltip({ ...showTooltip, inclusive: true })
                          }
                          onMouseLeave={() =>
                            setShowTooltip({ ...showTooltip, inclusive: false })
                          }
                          className={`w-full px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${
                        ...
                        {showTooltip.inclusive && (
                          <div className="absolute z-10 w-64 p-2 mt-2 text-sm text-white bg-gray-100 dark:bg-gray-700 rounded-lg shadow-lg">
                            in the total amount. Example: Total 118 includes 18%
                            GST (Base 100)
                          </div>
                        )}
                      </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3  bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700   rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-colors"
                      placeholder={
                        calculationType === "exclusive"
                      ...
                      {isCustomRate && (
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="w-24 px-3 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-colors"
                            placeholder="Enter %"
                          />
              ...
              <div className="space-y-6">
                {result ? (
                  ...
                  <div className="bg-white dark:bg-gray-700 p-6 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center justify-center">
                    <p className="text-gray-500 dark:text-gray-100 text-center">
            ...
            <div className="mt-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Chart */}
                <div className="bg-white dark:bg-gray-700 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
                  <h3 className="text-sm font-medium text-gray-600 dark:text-gray-100   mb-4">
                    Amount Distribution
                  </h3>
                  {result ? (
