            ...
            {!file ? (
              <div className="relative">
                ...
                >
                  ...
                  <p className="mt-4 text-sm font-medium dark:text-gray-100 text-gray-900">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center pb-4 border-b">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="px-3 py-1.5 dark:text-gray-100 text-gray-900 hover:bg-gray-100 rounded-md transition-colors text-sm"
                    >
                      Rotate Left
                    </button>
                    <button
                  ...
                  {splitPages.map(
                    (pageUrl, index) =>
                      pageUrl && (
                        <div
                          key={index}
                          className="relative bg-gray-100 dark:bg-gray-800 rounded-lg p-2 hover:shadow-lg transition-all duration-300 group"
                        >
                ...
                <div className="flex items-center gap-4 pt-4 border-t">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border dark:bg-gray-800 bg-gray-100 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                  <button
