  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-4">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white dark:bg-gray-700 rounded-[30px] shadow-md border-2 dark:border-gray-700 border-gray-100">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-2 border-b dark:border-gray-700 border-gray-100">
          ...
          <div className="p-6">
            {error && (
              <div className="mb-6 p-3 bg-red-50 dark:bg-gray-700 text-red-600 rounded-xl border border-red-200 text-sm">
                {error}
              </div>
            )}
                ...
                <form onSubmit={calculateDiscount} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      value={originalPrice}
                      onChange={(e) =>
                        handleNumberInput(e.target.value, setOriginalPrice)
                      }
                      className="w-full px-4 py-3 dark:bg-gray-600 dark:border-gray-600   bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-colors"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNumberInput(e.target.value, setDiscountPercentage)
                      }
                      className="w-full px-4 py-3 dark:bg-gray-600 dark:border-gray-600 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-colors"
                ...
                {result ? (
                  <div className="bg-white dark:bg-gray-700 p-6 rounded-xl border border-gray-200">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 bg-indigo-50 dark:bg-gray-600 rounded-lg h-32 flex flex-col justify-center">
                      ...
                      <div className="p-4 bg-green-50 dark:bg-gray-600  rounded-lg h-32 flex flex-col justify-center">
                        <p className="text-sm dark:text-gray-300 text-gray-600">
                          You Save
                        </p>
                      ...
                      <div className="p-4 bg-blue-50 dark:bg-gray-600 rounded-lg h-32 flex flex-col justify-center">
                        <p className="text-sm dark:text-gray-300 text-gray-600">
                          Final Price
                        </p>
                      ...
                      <div className="p-4 bg-purple-50 dark:bg-gray-600   rounded-lg h-32 flex flex-col justify-center">
                        <p className="text-sm dark:text-gray-300 text-gray-600">
                          Savings
                        </p>
