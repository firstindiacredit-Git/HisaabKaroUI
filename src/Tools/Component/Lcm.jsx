            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 space-y-6">
              ...
              {steps.length > 0 && (
                <div className="space-y-4">
                  {/* Main Result */}
                  <div className="bg-white p-4 dark:bg-gray-600 rounded-xl border border-gray-200 dark:border-gray-600  ">
                    <div className="text-center">
                      <p className="text-sm dark:text-white text-gray-600 mb-1">LCM</p>
                    ...
                    <div className="space-y-2">
                      {steps.map((step, index) => (
                        <div key={index} className="text-sm">
                          {step.type === "start" && (
                            <p className="text-gray-600 dark:text-red-500">
                              Numbers: {step.numbers}
                            </p>
                          )}
                          {step.type === "step" && (
                            <p className="text-gray-600 dark:text-green-500">
                              LCM({step.numbers[0]}, {step.numbers[1]}) ={" "}
                              {step.lcm}
                              <br />
                          ...
                          {step.type === "result" && (
                            <p className="text-gray-800 dark:text-green-500 font-medium">
                              Final LCM: {step.lcm}
                            </p>
                          )}
                        </div>
