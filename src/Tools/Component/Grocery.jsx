              ...
              <form onSubmit={handleSubmit} className="mb-6 sm:mb-8">
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-50 dark:bg-gray-800 rounded-xl border border-gray-100 shadow-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all dark:text-white dark:border-gray-700"
                    />
                  </div>
                  <div className="relative">
                    <input
                ...
                <div className="flex items-center gap-4 mb-6">
                  <button
                    ...
                    className="px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-50 rounded-xl border border-gray-100 shadow-sm text-gray-700 hover:from-blue-100 hover:to-gray-200 transition-all flex items-center gap-2 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700"
                  >
                    <svg
