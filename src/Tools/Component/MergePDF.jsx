            ...
            {files.length === 0 ? (
              ...
              >
                ...
                <label htmlFor="initial-file-upload" className="cursor-pointer">
                  ...
                  <div className="mt-4">
                    <span className="mt-2 block text-sm dark:text-gray-100 font-medium text-gray-900">
              ...
              <div className="space-y-6">
                {files.map((file, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 dark:bg-gray-800 bg-gray-50 rounded-lg hover:shadow-md transition-shadow"
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-sm dark:text-gray-100 font-medium text-gray-900">
                          {file.name}
                        </p>
