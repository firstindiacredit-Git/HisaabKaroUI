                ...
                <div className="mb-6 bg-red-50 border-l-4 border-red-400 p-4 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <p className="ml-3 text-sm text-red-700">
                      Unable to access camera or microphone. Please check your
                      permissions.
                    </p>
                    <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setSelectedCameraIndex(Number(e.target.value))
                        }
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setSelectedMicIndex(Number(e.target.value))
                        }
                        className="block w-full px-4 py-3 dark:bg-gray-900 text-gray-700 dark:text-gray-300 dark:border-gray-900     bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-200 focus:border-teal-400 transition-colors"
                      >
                  ...
                  {hasCapture && (
                    <div className="space-y-4">
                      <div className="relative rounded-xl overflow-hidden bg-gray-900">
                        <img ref={imageRef} className="w-full" alt="Captured" />
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6">
                    <h3 className="text-lg font-semibold dark:text-gray-300 text-gray-900 mb-4">
                      Camera Information
                    </h3>
                    <div className="divide-y dark:divide-gray-800   divide-gray-200">
                      {Object.entries(cameraSettings).map(([key, value]) => (
                        <div key={key} className="py-3 flex justify-between">
                          ...
                          <span className="text-sm dark:text-gray-300 text-gray-900">{value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
