...
const PdfToImage = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div
          className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 shadow-[0_8px_30px_rgb(0,0,0,0.12)] 
        ...
        >
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-sm dark:text-gray-100 text-gray-900">
            ...
            {!pdfFile ? (
              <div className="relative border-2 border-dashed rounded-lg p-12 text-center border-gray-300 hover:border-gray-400">
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-xs dark:text-gray-100 text-gray-900">
                      PDF files only
                    </p>
                  </div>
                </label>
              ...
              <div className="space-y-6">
                    ...
                    >
                      ...
                      >
                        <div className="absolute top-2 left-2 right-2 flex justify-between items-center">
                          <div className="bg-black/50 dark:bg-gray-100/50 text-white text-sm px-2 py-1 rounded">
                            Page {image.pageNumber}
                          </div>
                          <button
                            onClick={() => deleteImage(index)}
                            className="p-1.5 bg-red-500/80 dark:bg-red-500/80 hover:bg-red-500 rounded-full text-white"
                          >
                            <FaTrash size={12} />
                          </button>
                        </div>
                        <div className="absolute bottom-2 left-2 right-2 flex gap-2">
                          <button
                            onClick={() =>
                              downloadImage(
                                image.url,
                                `page-${image.pageNumber}.${imageFormat}`
                              )
                            }
                            className="flex-1 flex items-center justify-center gap-1 bg-blue-500/80 dark:bg-blue-500/80 hover:bg-blue-500 text-white text-sm py-1 px-2 rounded"
                          >
                            <FaDownload size={12} />
                            <span>Download</span>
                          </button>
                ...
                <div className="mt-4 text-xs text-gray-500">
                  <p>
                    • Images will be saved in {imageFormat.toUpperCase()} format
                  </p>
