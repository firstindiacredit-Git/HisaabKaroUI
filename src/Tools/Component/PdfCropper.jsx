        ...
        >
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold dark:text-gray-100 text-gray-900">PDF Cropper</h1>
              <p className="mt-2 text-sm dark:text-gray-100 text-gray-900">
                Crop specific areas from your PDF
              </p>
            </div>
            ...
            {!pdfFile ? (
              ...
              <div className="space-y-6">
                ...
                <div className="mt-4 text-xs text-gray-500">
                  <p>
                    • Draw a rectangle on the PDF to select the area to crop
                  </p>
                  <p>
                    • Click the crop button to save the selected area as a new
                    PDF
                  </p>
