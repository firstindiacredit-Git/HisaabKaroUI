...
const Bmi = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100 flex items-start justify-center pt-4">
      <div className="max-w-2xl w-full px-2">
        <div className="bg-white dark:bg-gray-800 rounded-[30px] shadow-md overflow-hidden border-2 dark:border-gray-800 border-gray-100">
          {/* Back Button */}
          ...
          <form onSubmit={calculateBMI} className="p-4 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-1">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-colors"
                >
            ...
            {/* Results */}
            {bmi && (
              <div className="mt-4 dark:bg-gray-700  bg-gray-50 rounded-2xl p-4 border dark:border-gray-700 border-gray-200">
                <h2 className="text-xl font-semibold dark:text-gray-300 text-gray-800 mb-4 text-center">
                  BMI Results
                </h2>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-3 dark:bg-gray-600 rounded-xl border border-gray-200">
                    <p className="text-sm font-medium dark:text-gray-300 text-gray-600">BMI</p>
                  ...
                  <div className="col-span-2 bg-white p-3 dark:bg-gray-600 rounded-xl border border-gray-200">
                      <p className="text-sm font-medium dark:text-gray-300 text-gray-600">
                      Your Weight
                    </p>
                    <p className="text-lg font-bold text-indigo-600">
