      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-4 sm:p-6 md:p-8">
            {/* Stopwatch Display */}
            <div className="bg-blue-50 dark:bg-gray-900 dark:border-gray-900 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-sm border border-gray-100">
              <div className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-wider text-center font-mono text-gray-800 dark:text-gray-300    ">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200">
                        <th className="py-2 px-3 sm:px-4 text-left text-sm sm:text-base text-gray-600">
                          #
                        </th>
                        <th className="py-2 px-3 sm:px-4 text-left text-sm sm:text-base text-gray-600">
                          Time
                    ...
                    <tbody>
                      {pausedTimes.map((time, index) => (
                        <tr key={index} className="border-b border-gray-200">
                          <td className="py-2 px-3 sm:px-4 text-sm sm:text-base text-gray-800">
                            {index + 1}
                          </td>
