        ...
        >
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold dark:text-gray-100 text-gray-900">Unlock PDF</h1>
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-xs dark:text-gray-100 text-gray-900">
                      Password protected PDF files only
                    </p>
                  </div>
                </label>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border dark:bg-gray-800 dark:text-gray-100 bg-gray-100  border-gray-300 rounded-lg focus:ring-2 
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs dark:text-gray-100 text-gray-900 mt-1">
                ...
                {message && !unlockedPdfUrl && (
                  <div className="p-4 bg-red-50 rounded-lg">
                    <p className="text-sm dark:text-gray-100 text-gray-900">{message}</p>
                  </div>
                )}
              </div>
            )}
