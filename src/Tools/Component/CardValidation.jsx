      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-4 sm:p-6 md:p-8">
            <div className="space-y-6 dark:text-white bg-white dark:bg-gray-800 ">
              {/* Card Input */}
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setCardNumbers(e.target.value)}
                      className="w-full px-4 sm:px-6 py-3 bg-blue-50 dark:bg-gray-800 rounded-xl border border-gray-100 shadow-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all dark:text-white dark:border-gray-700 h-32 resize-none"
                />
              </div>
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-gray-50 dark:bg-gray-700">
                          <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 dark:text-white border-b">
                            Card Number
                          </th>
                          <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 dark:text-white border-b">
                            Status
                      ...
                      <tbody className="divide-y">
                        {currentResults.map((result, index) => (
                          <tr key={index} className="hover:bg-gray-50 bg-gray-50 dark:bg-gray-600 dark:hover:bg-gray-500">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                        currentPage === 1
                          ...
                          : "bg-white dark:bg-gray-700 text-gray-600 hover:bg-gray-50 border border-gray-200"
                      }`}
                    >
                      Previous
                    </button>
