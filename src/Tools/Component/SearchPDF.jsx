...
const ExcelSearch = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100 flex flex-col items-center justify-center p-6 -mt-16">
      <div className="bg-white dark:bg-gray-900 shadow-md rounded-lg p-8 w-full max-w-full lg:max-w-8xl">
        ...
        <div>
          <button className="px-4 py-2 bg-blue-500 text-white  rounded-lg hover:bg-blue-600">
            <a href="https://www.ilovepdf.com/pdf_to_excel" target="_blank">
              Click And Convert Pdf To Excel
            </a>
          </button>
        </div>
        ...
        {/* Upload Excel File */}
        <h1 className="font-semibold px-2 py-2">Upload Excel File</h1>
        <input
          type="file"
          accept=".xlsx, .xls"
          onChange={handleFileUpload}
        ...
        <input
          ...
          onChange={handleSearch}
          placeholder="Search for data..."
          className="w-full border dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700 bg-gray-100 border-gray-300 rounded-lg p-4 mb-6 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
