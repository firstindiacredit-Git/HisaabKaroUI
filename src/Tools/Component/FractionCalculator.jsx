...
const FractionCalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 dark:from-gray-900 to-gray-200 dark:to-gray-800 py-4">
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white dark:bg-gray-800 rounded-[30px] shadow-md border-2 dark:border-gray-800 border-gray-100">
          ...
          <div className="bg-gradient-to-r from-gray-50 dark:from-gray-800 to-white dark:to-gray-800 p-2 border-b border-gray-100 dark:border-gray-600">
