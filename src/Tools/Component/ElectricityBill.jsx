...
const ElectricityBillCalculator = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100  py-4 px-2 sm:px-4">
                ...
                <form onSubmit={calculateBill} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {Object.entries(stateRates).map(([state, rates]) => (
                        <button
                          ...
                          className="px-3 py-2 rounded-lg font-medium text-sm dark:border-gray-700 dark:text-white transition-colors duration-200 dark:bg-gray-700 bg-white text-gray-700 border border-gray-200 hover:bg-gray-50"
                        >
                          {state}
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 dark:bg-gray-700 dark:border-gray-700 dark:text-white bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-colors"
                  ...
                  <>
                    <div className="bg-white dark:bg-gray-700 p-4 sm:p-6 rounded-xl border dark:border-gray-700 border-gray-200">
                      <div className="grid grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div className="p-3 sm:p-4 dark:bg-gray-600 bg-blue-50 rounded-lg sm:h-32 flex flex-col justify-center">
                          <p className="text-sm dark:text-white text-gray-600">
                            Rate per Unit
                          </p>
                        ...
                        <div className="p-3 sm:p-4 dark:bg-gray-600 bg-orange-50 rounded-lg sm:h-32 flex flex-col justify-center">
                          <p className="text-sm dark:text-white text-gray-600">
                            Fixed Charges
                          </p>
                      ...
                      <div className="mt-4 p-3 sm:p-4 dark:bg-gray-600 bg-purple-50 rounded-lg text-center">
                          <p className="text-sm dark:text-white text-gray-600 mb-1">Total Bill</p>
