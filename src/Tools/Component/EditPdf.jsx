          ...
          <div className="p-6">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-sm dark:text-gray-100 text-gray-900">
                Edit text content in your PDF files
              </p>
            </div>
            ...
            {!pdfFile ? (
              <div className="relative border-2 border-dashed rounded-lg p-12 text-center border-gray-300 hover:border-gray-400">
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <div className="mt-4">
                    <span className="mt-2 block dark:text-gray-100 text-sm font-medium text-gray-900">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <textarea
                    ...
                    rows={10}
                    className="w-full p-3 border border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
