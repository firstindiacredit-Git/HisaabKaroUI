...
const DraggableImage = ({ image, index, moveImage, deleteImage, isDraggingDisabled, setIsDraggingDisabled }) => {
  ...
  return (
    <motion.div
      ...
      className="group dark:bg-gray-900 relative aspect-[3/4] rounded-lg overflow-hidden cursor-move"
    >
      <img
        src={image.url}
        alt={image.name}
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-900 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.12)] 
        ...
        >
          <div className="p-4 border-b flex items-center border-gray-100 dark:border-gray-800">
            <span className="text-gray-900 flex items-center rounded-full bg-blue-100 dark:bg-gray-200/50 border border-gray-100 dark:border-gray-800 pr-4 dark:text-gray-100">
              <Back />Back
            </span>
          </div>
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold dark:text-gray-100 text-gray-900">Image to PDF</h1>
