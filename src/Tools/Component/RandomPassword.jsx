                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <input
                      ...
                      min="6"
                      max="32"
                      className="w-16 px-2 py-1 border text-black bg-white dark:text-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-lg text-center focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="flex items-center">
                  <input
                    ...
                    className="w-full px-4 sm:px-6 py-3  bg-blue-50 dark:bg-gray-800 rounded-xl border border-gray-100 shadow-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all dark:text-white dark:border-gray-700 font-mono"
                  />
                  {password && (
                    <button
                      onClick={handleCopy}
