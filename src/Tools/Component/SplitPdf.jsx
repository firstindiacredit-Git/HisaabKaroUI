...
const SplitPdf = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-100 p-2 sm:p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="relative p-2 sm:p-6">
            ...
            <h1 className="text-xl mt-1 sm:text-3xl md:text-4xl font-bold text-center bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">
              Split PDF
            </h1>
            ...
            {!file ? (
              <div className="relative border-2 border-dashed rounded-xl p-6 sm:p-12 text-center border-gray-300 hover:border-gray-400 transition-colors">
                ...
                <label htmlFor="fileInput" className="cursor-pointer block">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto bg-blue-50 dark:bg-gray-800 rounded-2xl flex items-center justify-center">
                    <svg
                      className="w-8 h-8 sm:w-10 sm:h-10 text-blue-500 dark:text-gray-100"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div className="mt-4">
                    <span className="text-sm dark:text-gray-100 sm:text-base font-medium text-gray-900">
                      Choose PDF file or{" "}
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex-1">
                          ...
                          <input
                            ...
                            min="1"
                            max={totalPages}
                            className="w-full dark:bg-gray-900 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                          />
                        </div>
                  ...
                  {splitPages.map(
                    (pageUrl, index) =>
                      pageUrl && (
                        <div
                          key={index}
                          className="relative bg-gray-50 dark:bg-gray-900 rounded-xl p-3 hover:shadow-lg transition-all duration-300 group"
                        >
