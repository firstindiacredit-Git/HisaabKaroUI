        ...
        >
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold dark:text-gray-100 text-gray-900">Protect PDF</h1>
              ...
              >
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-xs dark:text-gray-100 text-gray-900">PDF files only</p>
                  </div>
                </label>
              </div>
            ) : (
